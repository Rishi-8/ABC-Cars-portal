...
<script src="/ABC_Car/js/custom.js"></script>
...
<body>
	...
	<div class="container-fluid bg-1 text-center">
		<h3 class="margin">Register to ABC Cars</h3>
		...
		<div class="row">
			...
			<div class="form-wrap">
				<span class="form-head">Register</span>
				...
				<form:form action="save" method="post" modelAttribute="user">
					...
					<div class="form-group">
						<label for="username" class="form-label">Your Login User Name:</label>
					...
					<input type="submit" value="Register" class="btn btn-primary login"/>
